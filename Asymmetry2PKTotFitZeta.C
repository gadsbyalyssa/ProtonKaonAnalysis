...
const Int_t n1 = 4;
Double_t x1[n1] = {0.25, 0.35, 0.45, 0.55};
Double_t y1[n1] = {-0.012034, -0.0143132, 0.0090209, 0.019763};
Double_t ex1[n1] = {0, 0, 0, 0};
Double_t ey1[n1] = {0.0032608, 0.0061311, 0.0148668, 0.059624};

TF1 *f2= new TF1("f2","[0]*x+[1]",0,0.45);
TGraphErrors*h2 = new TGraphErrors(n1,x1,y1,ex1,ey1);

h2->GetXaxis()->SetTitle("Zeta");
