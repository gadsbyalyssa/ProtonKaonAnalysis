...
void Asymmetry2PKSpringFitZeta()
{
...
Double_t y1[n1] = {-0.01062, -0.0187266, 0.014045, 0.031914};
Double_t ex1[n1] = {0, 0, 0, 0};
Double_t ey1[n1] = {0.0045511, 0.00864565, 0.021199, 0.086205};

TF1 *f2= new TF1("f2","[0]",0,0.45);
