...
void FitMethodTreeFallZeta(){
    ...
    FILE *fp = fopen("PKFall2018Skim4NewJar.txt","r");
...
TCut Mxg1 = ("Mx>1 && y<0.75 && xF1<0 && xF2>0&& -10<vz_e&&vz_e<4 && 1.15<p2_p&&p2_p<3 && 0.4<p1_p && e_p>2.35 && vz_p2<13 && vz_p1<13");
TCut X1 = ("0.2<x&&x<0.3");
TCut X2 = ("0.3<x&&x<0.4");
TCut X3 = ("0.4<x&&x<0.5");
TCut X4 = ("0.5<x&&x<0.6");
...
outTree->Draw("Delta_phi>>h1", PosHeli && X1 && Mxg1);
///////////////////////////////////////////////////////////////
TH1F*h2 = new TH1F("h2","h2",20, 0, 6.4);
c01->cd(2);
h2->GetXaxis()->SetTitle("[0<x<0.2]");
...
outTree->Draw("Delta_phi>>h2", NegHeli && X1 && Mxg1);
...
c02->cd(1);
h3->GetXaxis()->SetTitle("[0.2<x<0.3]");
...
outTree->Draw("Delta_phi>>h3", PosHeli && X2 && Mxg1);
///////////////////////////////////////////////////////////////
TH1F*h4 = new TH1F("h4","h4",20, 0, 6.4);
c02->cd(2);
h4->GetXaxis()->SetTitle("[0.2<x<0.3]");
...
outTree->Draw("Delta_phi>>h4", NegHeli && X2 && Mxg1);
...
c03->cd(1);
h5->GetXaxis()->SetTitle("[0.3<x<0.4]");
...
outTree->Draw("Delta_phi>>h5", PosHeli && X3 && Mxg1);
///////////////////////////////////////////////////////////////
TH1F*h6 = new TH1F("h6","h6",20, 0, 6.4);
c03->cd(2);
h6->GetXaxis()->SetTitle("[0.3<x<0.4]");
...
outTree->Draw("Delta_phi>>h6", NegHeli && X3 && Mxg1);
...
c04->cd(1);
h7->GetXaxis()->SetTitle("[0.4<x<0.5]");
...
outTree->Draw("Delta_phi>>h7", PosHeli && X4 && Mxg1);
///////////////////////////////////////////////////////////////
TH1F*h8 = new TH1F("h8","h8",20, 0, 6.4);
c04->cd(2);
h8->GetXaxis()->SetTitle("[0.4<x<0.5]");
...
outTree->Draw("Delta_phi>>h8", NegHeli && X4 && Mxg1);
...
c05->cd(1);
h9->GetXaxis()->SetTitle("[0.5<x<0.6]");
...
outTree->Draw("Delta_phi>>h9", PosHeli && X5 && Mxg1);
///////////////////////////////////////////////////////////////
TH1F*h10 = new TH1F("h10","h10",20, 0, 6.4);
c05->cd(2);
h10->GetXaxis()->SetTitle("[0.5<x<0.6]");
...
outTree->Draw("Delta_phi>>h10", NegHeli && X5 && Mxg1);
...
c06->cd(1);
h11->GetXaxis()->SetTitle("[0.6<x<0.7]");
...
outTree->Draw("Delta_phi>>h11", PosHeli && X6 && Mxg1);


///////////////////////////////////////////////////////////////
TH1F*h12 = new TH1F("h12","h12",20, 0, 6.4);
c06->cd(2);
h12->GetXaxis()->SetTitle("[0.6<x<0.7]");
...
outTree->Draw("Delta_phi>>h12", NegHeli && X6 && Mxg1);
///////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////
