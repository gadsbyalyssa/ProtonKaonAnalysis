...
void FitMethodTreeTotpTpT(){
    ...
    fscanf(fp, " %f %f %f %f %f %f %f %f ", &Q2, &W, &phi2, &phi1, &x, &y, &zeta, &xF);
...
///////////////////////////////////////////////////////////////
    ...
    c02->cd(1);
    h3->GetXaxis()->SetTitle("[0.1<x<0.2]");
    ...
    c02->cd(2);
    h4->GetXaxis()->SetTitle("[0.1<x<0.2]");
    ...
    c03->cd(1);
    h5->GetXaxis()->SetTitle("[0.2<x<0.3]");
    ...
    c03->cd(2);
    h6->GetXaxis()->SetTitle("[0.2<x<0.3]");
    ...
    c04->cd(1);
    h7->GetXaxis()->SetTitle("[0.3<x<0.4]");
    ...
    c04->cd(2);
    h8->GetXaxis()->SetTitle("[0.3<x<0.4]");
    ...
    c05->cd(1);
    h9->GetXaxis()->SetTitle("[0.4<x<0.5]");
    ...
    c05->cd(2);
    h10->GetXaxis()->SetTitle("[0.4<x<0.5]");
    ...
    c06->cd(1);
    h11->GetXaxis()->SetTitle("[0.5<x<0.6]");
    ...
    c06->cd(2);
    h12->GetXaxis()->SetTitle("[0.5<x<0.6]");
